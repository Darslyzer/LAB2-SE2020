...
public class Shop : MonoBehaviour {
	...
	void  OnGUI (){
		...
		ItemData dataItem = database.GetComponent<ItemData>();
		int[] itemQuantity = player.GetComponent<Inventory>().itemQuantity;
		int cash = player.GetComponent<Inventory>().cash;
		int[] itemSlot = player.GetComponent<Inventory>().itemSlot;
		int[] equipment = player.GetComponent<Inventory>().equipment;
